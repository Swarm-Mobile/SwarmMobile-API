...
class ExpMember extends AppModel {
    ...
    public function authenticate($username, $password) {
        $res = $this->find('first', array(
            ...
            'fields' => array('ExpMember.member_id', 'ExpMember.group_id', 'ExpMember.email', 'ExpMember.username',
                'ExpMember.password', 'ExpMember.salt', 'MemberData.m_field_id_28 as store_id'),
            'joins' => array(
                array(
