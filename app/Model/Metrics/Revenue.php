...
class Revenue extends CacheMetricModel
{

    public $useTable = 'revenue';
    ...
    public function getFromRaw ()
    {
        ...
        $query = [
            'fields' => ['SUM(revenue) as value, date, hour'],
    ...
    public function storeInCache ($result = [])
    {
        ...
        foreach ($result as $date => $rows) {
            ...
            $totals = new Totals();
            $totals->updateRollupMetric($date, $this->data[__CLASS__]['location_id'], 'revenue', $data[$totalIndex]);
        }
    }
