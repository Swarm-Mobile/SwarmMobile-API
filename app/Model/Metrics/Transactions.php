...
class Transactions extends CacheMetricModel
{
    ...
    public function getFromRaw ()
    {
        ...
        $query = [
            'fields' => ['COUNT(*) as value, date, hour'],
    ...
    public function storeInCache ($result = [])
    {
        ...
        foreach ($result as $date => $rows) {
            ...
            $totals = new Totals();
            $totals->updateRollupMetric($date, $this->data[__CLASS__]['location_id'], 'transactions', $data[$totalIndex]);
        }
    }
